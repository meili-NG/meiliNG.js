...
module.exports = {
  ...
  deploy: {
    production: {
      ...
      'pre-deploy-local': `scp -o StrictHostKeyChecking=no -o LogLevel=VERBOSE ${keyOption} -Cr ./.env ${process.env.DEPLOY_PRODUCTION_USER}@${process.env.DEPLOY_PRODUCTION_HOST}:${process.env.DEPLOY_PRODUCTION_PATH}/current`,
