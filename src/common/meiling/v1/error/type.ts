export enum ErrorType {
  ...
  AUTHENTICATION_REQUEST_INVALID = 'authorization_request_invalid',
  AUTHENTICATION_REQUEST_NOT_COMPLETED = 'authorization_request_not_completed',
  AUTHENTICATION_REQUEST_RATE_LIMITED = 'authorization_request_rate_limited',
